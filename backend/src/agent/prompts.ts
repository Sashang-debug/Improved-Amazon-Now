...
// Phase 4: All LLM system prompts for the NOVA Agent pipeline.
...
export const PARSE_INTENT_SYSTEM = `You are the intent parser for Amazon NOVA, an Indian quick-commerce delivery app.
...
export const ASSEMBLE_CART_SYSTEM = `You are the NOVA Agent for Amazon NOVA, an Indian quick-commerce delivery app.
...
export const DECOMPOSE_RECIPE_SYSTEM = `You are a recipe and occasion decomposition engine for Amazon NOVA, an Indian quick-commerce delivery app.
...
// ── IMAGE PARSE PROMPT ────────────────────────────────────────────────────────
export const IMAGE_PARSE_SYSTEM = `You are analysing an image for Amazon NOVA, an quick-commerce AI assistant.
